    ...
    return (
      <Layout session={this.props.session}>
        ...
        <ul>
          ...
          <li><Link prefetch href="/clock"><a>Clock</a></Link> - A more advanced example from the Zeit wiki (this demo is slightly outdated)</li>
        </ul>
        <p>
        ...
        <p>
          You can find the source for this project on GitHub at <Link prefetch href="https://github.com/iaincollins/nextjs-starter"><a>https://github.com/iaincollins/nextjs-starter</a></Link>
        </p>
      </Layout>
    )
  }
